...
class circular_average_subtract(Protocols.circular_average):
    ...
    def run(self, data, output_dir, **run_args):
        ...
        background_filename = './circular_average/blank_180.00s_314959_waxs.dat'
...
calibration.set_distance(0.229) # Bigger number moves theory rings outwards (larger spacing)
calibration.set_beam_position(5.0, 1042--17.0)
...
protocols = [
    ...
    Protocols.circular_average(ylog=False, plot_range=[0, 4.0, 1000, None], dezing=True) ,
